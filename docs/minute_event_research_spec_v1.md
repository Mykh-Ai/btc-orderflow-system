...
This document translates the research shift defined in `deltascout/research_material/research_blueprint_v2.md` into an implementation-oriented analyzer roadmap.

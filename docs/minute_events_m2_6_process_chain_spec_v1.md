...
- local DeltaScout research blueprint materials
- local minute-event research notes and specs
- current family-level findings and handoff materials in the local-only research workspace
